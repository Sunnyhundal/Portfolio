      ...
      <div>
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-base md:text-xl">
            ...
            <span className="font-semibold">accessible websites </span> that
            just work. I come from a background in{" "}
            <span className="font-semibold">
              economics and international education
            </span>
            , and am always looking for ways to combine my interests in
