...
export default function About() {
  return (
    <div className="flex flex-col lg:flex-row justify-center lg:justify-between mt-5 lg:w-2/3 lg:h-2/3">
      <div className="bg-slate-200 p-6 lg:p-24 grow opacity-75 lg:w-1/3 lg:mr-2.5 rounded-xl drop-shadow-md mb-5 lg:mb-0">
